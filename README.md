...
O **Listadex Pro** foi desenvolvido como uma aplicação web de produtividade para gerenciar tarefas de forma prática e visual. A proposta do projeto foi evoluir de uma lista de tarefas simples para uma versão mais robusta, com recursos que aproximam a aplicação de um sistema real de organização pessoal.
...
![Preview do Listadex Pro](./imagens/Print1.png)
